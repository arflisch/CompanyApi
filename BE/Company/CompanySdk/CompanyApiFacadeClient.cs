...
namespace CompanyApi.Facade.Sdk
{
    ...
    #pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        ...
        public virtual async System.Threading.Tasks.Task<FileResponse> PatchCompanyNameAsync(long id, string name, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "Company/name/{id}/{Name}"
                    urlBuilder_.Append("Company/name/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(id, System.Globalization.CultureInfo.InvariantCulture)));
                    urlBuilder_.Append('/');
        ...
        public virtual async System.Threading.Tasks.Task<FileResponse> PatchCompanyVatAsync(long id, string vat, System.Threading.CancellationToken cancellationToken)
        {
            ...
            if (vat == null)
                throw new System.ArgumentNullException("vat");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "Company/Vat/{id}/{Vat}"
                    urlBuilder_.Append("Company/Vat/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(id, System.Globalization.CultureInfo.InvariantCulture)));
                    urlBuilder_.Append('/');
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(vat, System.Globalization.CultureInfo.InvariantCulture)));
